...
def get_tables_values(data, day, tables):
    hostip = data.get('hostip', None)
    user = data.get('user', None)
    passwd = data.get('passwd', None)
    db = data.get('db', None)
...
def main():
    ...
    source_table_name = get_table_name(source_config)
    dest_table_name = get_table_name(dest_config)

    source_data = get_tables_values(source_config, day, source_table_name)
    dest_data = get_tables_values(dest_config, day, dest_table_name)
