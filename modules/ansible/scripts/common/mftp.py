...
from common import logMsg, run_cmd
...
if __name__ == "__main__":
    args = dict()
    args['ftp_host'] = '120.132.92.111'
    args['ftp_user'] = 'ftpuser'
    args['ftp_pswd'] = 'gZy4humhqb5wosUc'
    f = ftpBase(**args)
    f._checkDir('miles')
    f.listDir()
    f.findFile('1.conf')
    f.findFile('1')
    f.uploadDir(local_dir='/root/miles/script/yunwei/web', remote_dir='/web')
