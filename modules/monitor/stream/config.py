...
streaming = [{'hosts': 'bigdata-appsvr-130-3', 'type': 'yarn_list', 'keyword': 'interest-onlineALS', 'users': 'spark',
             'commands': 'sh /opt/ai/interestOptimization-201707/release/bin/onlineALS.sh', 'alter_mail': 'peng.tao@whaley.cn,fang.dong@whaley.cn,lian.kai@whaley.cn'},
            {'hosts': 'bigdata-appsvr-130-3', 'type': 'yarn_list', 'keyword': 'interest-online-user-actions',
             'users': 'spark', 'commands': 'sh /opt/ai/interestOptimization-201707/release/bin/online-user-actions.sh','alter_mail': 'peng.tao@whaley.cn,fang.dong@whaley.cn,lian.kai@whaley.cn'},
            {'hosts': 'bigdata-appsvr-130-5', 'type': 'yarn_list', 'keyword': 'interest-online-sid-generation', 'users': 'spark',
             'commands': 'sh /opt/ai/interestOptimization-201707/release/bin/online-sid-generation.sh','alter_mail': 'peng.tao@whaley.cn,fang.dong@whaley.cn,lian.kai@whaley.cn'},
